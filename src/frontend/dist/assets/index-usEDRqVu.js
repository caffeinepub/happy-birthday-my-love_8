...
function ParticleCanvas() {
  ...
  reactExports.useEffect(() => {
    ...
    const drawHeart = (ctx2, x, y, size) => {
      ctx2.save();
      ctx2.translate(x, y);
      ctx2.beginPath();
      const s = size * 0.5;
      ctx2.moveTo(0, s * 0.4);
      ctx2.bezierCurveTo(s * 0.5, -s * 0.8, s * 1.4, s * 0.1, 0, s * 1.2);
      ctx2.bezierCurveTo(-s * 1.4, s * 0.1, -s * 0.5, -s * 0.8, 0, s * 0.4);
      ctx2.closePath();
      ctx2.fill();
      ctx2.restore();
    };
    const drawStar = (ctx2, x, y, size) => {
      const r1 = size * 0.5;
      const r2 = size * 0.2;
      ctx2.save();
      ctx2.translate(x, y);
      ...
      for (let i = 0; i < 5; i++) {
        ...
        if (i === 0) ctx2.moveTo(Math.cos(a1) * r1, Math.sin(a1) * r1);
        else ctx2.lineTo(Math.cos(a1) * r1, Math.sin(a1) * r1);
    ...
    const tick = () => {
      ...
      for (let i = particles.length - 1; i >= 0; i--) {
        ...
        p.opacity = lifeRatio < 0.1 ? lifeRatio * 10 : lifeRatio > 0.85 ? (1 - lifeRatio) / 0.15 : 1;
        if (p.age >= p.maxAge) {
...
function PhotoSlot({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: `photo-placeholder ${className}`, style: style2, children: [
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "header",
    {
      ...
      style: {
        ...
        borderBottom: scrolled ? "1px solid oklch(0.28 0.022 340 / 0.4)" : "none"
      },
      children: [
              ...
              children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "w-6 flex flex-col gap-1.5", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "span",
                  {
                    ...
                    style: {
                      background: "var(--gold)",
                      transform: mobileOpen ? "rotate(45deg) translate(3px, 5px)" : void 0
                    }
                  }
                ),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-6xl mx-auto w-full", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid md:grid-cols-2 gap-12 items-center", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "h1",
              {
                ...
                children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "gold-text", children: "My Love!" })
                ]
              }
            )
          ] }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              ...
              children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm tracking-wide", children: "With all my love, always & forever" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "span",
                  {
                    style: {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            ...
            children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative", style: { width: "min(340px, 80vw)" }, children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "div",
                {
                  className: "absolute inset-0 rounded-3xl",
                  style: {
                    background: "radial-gradient(circle at 60% 40%, oklch(0.72 0.09 350 / 0.15) 0%, transparent 65%)",
...
function TimelineSection() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "story", className: "section", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-5xl mx-auto", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-col gap-16", children: timelineEntries.map((entry, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          className: `flex items-center gap-6 md:gap-0 ${entry.side === "left" ? "reveal-left" : "reveal-right"}`,
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "div",
              {
                ...
                children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "glass-card p-5 max-w-xs", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    PhotoSlot,
                    {
                      label: "Add Photo",
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "hidden md:flex w-2/12 justify-center relative z-10", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "timeline-dot" }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "div",
              {
                className: `w-full md:w-5/12 ${entry.side === "left" ? "md:justify-start md:pl-10" : "md:justify-end md:pr-10"} md:flex`,
                children: [
...
function ForYouSection() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "for-you", className: "section", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-5xl mx-auto", children: [
          ...
          children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { padding: "1.75rem" }, children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "p",
              {
                className: "text-sm leading-relaxed",
                style: { color: "oklch(0.70 0.015 340)" },
                children: "Add your heartfelt words about her beauty here. Describe the way she smiles, the way she carries herself, or a specific memory that took your breath away. This is your space to tell her exactly what makes her radiant in your eyes."
              }
            )
          ] })
        }
          ...
          children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { padding: "1.75rem" }, children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "p",
              {
                className: "text-sm leading-relaxed",
                style: { color: "oklch(0.70 0.015 340)" },
                children: "Describe her intelligence, creativity, and wisdom here. Share a moment where her brilliance amazed you — a conversation, a decision, or a quiet insight that reminded you just how extraordinary she truly is."
              }
            )
          ] })
        }
...
function LoveLetter() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "love-letter", className: "section", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-5xl mx-auto", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid md:grid-cols-5 gap-0", children: [
              ...
              children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "div",
                  {
                    ...
                    children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "Write your love letter here. Start by telling her how she makes every single day feel like an adventure worth living. Let her know she is your favorite person on this earth." }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "Describe a moment that changed everything for you — one that made you realize she was the one you wanted to build your life with. Be specific. Be raw. Be honest." }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "Tell her about the future you imagine together. The small things — morning coffee, long walks, quiet evenings — and the big things — dreams, adventures, a family. Whatever your heart holds, write it here." }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "On this birthday, remind her that she is seen, she is loved, she is celebrated — today and every day that follows." })
                    ]
                  }
                ),
                /* @__PURE__ */ jsxRuntimeExports.jsxs(
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "md:col-span-2 p-8 flex items-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
            PhotoSlot,
            {
    ...
    "footer",
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-5xl mx-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid md:grid-cols-3 gap-8 items-center", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs", style: { color: "oklch(0.50 0.015 340)" }, children: "A love story written in stars." })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-col md:flex-row gap-4 items-start md:items-center md:justify-center", children: ["#home", "#story", "#for-you", "#love-letter"].map((href, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
          "a",
          {
            href,
            className: "nav-link text-xs",
            "data-ocid": "footer.link",
            children: ["Home", "Our Story", "For You", "Love Letter"][i]
          },
          href
        )) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-col items-start md:items-end gap-1", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs", style: { color: "oklch(0.45 0.015 340)" }, children: [
          "© ",
          year,
          ". Built with",
          " ",
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            ...
            style: {
              background: "radial-gradient(ellipse at center, transparent 40%, oklch(0.06 0.01 300 / 0.6) 100%)"
            },
            "aria-hidden": "true"
          }
        ),

...
const INTERACTIONS = ["wave", "spin", "purr", "jump"];
const CAT_WIDTH = 72;
...
function SingleCat({
  ...
  const [catX, setCatX] = reactExports.useState(
    () => startDir === 1 ? 60 : window.innerWidth - 130
  );
  const [direction, setDirection] = reactExports.useState(startDir);
  const [animation, setAnimation] = reactExports.useState("walk");
  const [showBubble, setShowBubble] = reactExports.useState(false);
  const [headTilt, setHeadTilt] = reactExports.useState(0);
  const [puffHearts, setPuffHearts] = reactExports.useState([]);
  const catXRef = reactExports.useRef(startDir === 1 ? 60 : window.innerWidth - 130);
  const dirRef = reactExports.useRef(startDir);
  const animRef = reactExports.useRef("walk");
  const rafRef = reactExports.useRef(0);
  const interactionTimer = reactExports.useRef(null);
  const cursorRef = reactExports.useRef({ x: window.innerWidth / 2, y: 0 });
  const heartCounterRef = reactExports.useRef(0);
  const pauseTimer = reactExports.useRef(null);
  ...
  const walkTiltDeg = animation === "walk" && !isPausedRef.current ? flipped ? -2 : 2 : 0;
  const celebStyle = celebrating ? {
    transition: "top 0.7s cubic-bezier(0.34,1.4,0.64,1), left 0.7s cubic-bezier(0.34,1.4,0.64,1), transform 0.7s ease",
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "button",
    {
      ...
      children: [
        showBubble && !celebrating && /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            style: {
              position: "absolute",
              ...
              pointerEvents: "none",
              animation: "cat-bubble-pop 0.3s cubic-bezier(0.34,1.56,0.64,1) forwards"
            },
            children: [
        ...
        puffHearts.map((h) => /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            style: {
              position: "absolute",
        ...
        animation === "jump" && !celebrating && /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            style: {
              position: "absolute",
              ...
              animation: "cat-exclaim 0.4s cubic-bezier(0.34,1.56,0.64,1) forwards",
              pointerEvents: "none"
            },
            children: "!"
          }
...
const EMOJI_POPPERS = ["🎉", "🎊", "🎆", "🎇", "✨", "🎈", "💥", "🌟"];
function BirthdayCelebrationOverlay({ onDone }) {
  const [confetti] = reactExports.useState(() => generateConfetti(50));
  const [phase, setPhase] = reactExports.useState("burst");
  reactExports.useEffect(() => {
    const t1 = setTimeout(() => setPhase("text"), 500);
    const t2 = setTimeout(() => setPhase("fading"), 3200);
    const t3 = setTimeout(() => onDone(), 4e3);
    return () => {
      clearTimeout(t1);
      clearTimeout(t2);
      clearTimeout(t3);
  ...
  const confettiKeyframes = confetti.map(
    (p) => `@keyframes confetti-fly-${p.id} {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            children: [
              confetti.map((p) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                "div",
                {
                  style: {
                    position: "absolute",
                    ...
                    fontSize: p.shape === "star" ? p.size : void 0,
                    lineHeight: p.shape === "star" ? 1 : void 0,
                    color: p.shape === "star" ? p.color : void 0,
                    animation: `confetti-fly-${p.id} ${p.duration}s ${p.delay}s cubic-bezier(0.25,0.46,0.45,0.94) both`
                  },
                  children: p.shape === "star" ? "★" : null
                },
                p.id
              )),
              EMOJI_POPPERS.map((emoji, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                "div",
                {
                  style: {
                    position: "absolute",
        ...
        phase !== "burst" && /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            style: {
              position: "relative",
              textAlign: "center",
              animation: phase === "fading" ? "birthday-text-out 0.8s ease forwards" : "birthday-text-in 0.6s cubic-bezier(0.34,1.56,0.64,1) forwards",
              zIndex: 2
            },
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "div",
                {
                  style: {
                    ...
                    fontWeight: 900,
                    lineHeight: 1.1,
                    background: "linear-gradient(135deg, #ff6b9d, #ffd700, #ff4757, #a29bfe)",
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "div",
                {
                  ...
                  children: "🐱 The cats love you too! 🐱"
                }
              )
            ]
          }
...
function WalkingCatsLayer() {
  const [pageHeight, setPageHeight] = reactExports.useState(0);
  const [clickCount, setClickCount] = reactExports.useState(0);
  const [celebrating, setCelebrating] = reactExports.useState(false);
  const centerX = typeof window !== "undefined" ? window.innerWidth / 2 - CAT_WIDTH / 2 : 300;
  const centerY = typeof window !== "undefined" ? window.scrollY + window.innerHeight / 2 - 45 : 300;
  reactExports.useEffect(() => {
    const update = () => setPageHeight(document.body.scrollHeight);
    update();
    window.addEventListener("resize", update);
    const t = setTimeout(update, 1e3);
    return () => {
  ...
  const handleCelebrationDone = reactExports.useCallback(() => {
    setCelebrating(false);
    setClickCount(0);
  }, []);
  if (!pageHeight) return null;
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    celebrating && /* @__PURE__ */ jsxRuntimeExports.jsx(BirthdayCelebrationOverlay, { onDone: handleCelebrationDone }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
        style: {
        ...
        children: CAT_CONFIGS.map((cfg) => /* @__PURE__ */ jsxRuntimeExports.jsx(
          SingleCat,
          {
            speed: cfg.speed,
            colorHue: cfg.color,
...
function CatSVG({
  ...
  const bodyAnim = isWalking ? "cat-body-walk 0.55s ease-in-out infinite" : animation === "spin" ? "cat-spin 0.7s cubic-bezier(0.45,0,0.55,1) forwards" : animation === "jump" ? "cat-jump 0.5s cubic-bezier(0.34,1.56,0.64,1) forwards" : animation === "purr" ? "cat-purr-shake 0.12s ease-in-out infinite alternate" : "none";
  const rightPawAnim = animation === "wave" ? "cat-wave 0.4s ease-in-out infinite alternate" : isWalking ? "cat-paw-walk 0.55s ease-in-out infinite" : "none";
  const leftPawAnim = isWalking ? "cat-paw-walk-alt 0.55s ease-in-out infinite" : "none";
  const tailAnim = animation === "purr" || paused ? "cat-tail-wag 0.5s ease-in-out infinite alternate" : "cat-tail-idle 3s ease-in-out infinite";
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "svg",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("g", { style: { transformOrigin: "20px 68px", animation: tailAnim }, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "path",
            {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("circle", { cx: "16", cy: "42", r: "4", fill: "oklch(0.82 0.16 72)" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("g", { style: { transformOrigin: "36px 72px", animation: bodyAnim }, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("ellipse", { cx: "36", cy: "65", rx: "22", ry: "18", fill: mainColor }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("ellipse", { cx: "36", cy: "67", rx: "13", ry: "11", fill: lightColor }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("g", { style: { transformOrigin: "26px 80px", animation: leftPawAnim }, children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("ellipse", { cx: "26", cy: "82", rx: "7", ry: "5", fill: darkColor }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("ellipse", { cx: "26", cy: "82", rx: "4", ry: "3", fill: "oklch(0.82 0.16 72)" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("g", { style: { transformOrigin: "46px 80px", animation: rightPawAnim }, children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("ellipse", { cx: "46", cy: "82", rx: "7", ry: "5", fill: mainColor }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("ellipse", { cx: "46", cy: "82", rx: "4", ry: "3", fill: "oklch(0.82 0.16 72)" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "path",
            {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "g",
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("circle", { cx: "36", cy: "44", r: "20", fill: mainColor }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("polygon", { points: "18,34 14,20 26,28", fill: mainColor }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("polygon", { points: "19,33 16,23 25,28", fill: "oklch(0.85 0.16 350)" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("polygon", { points: "54,34 58,20 46,28", fill: mainColor }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("polygon", { points: "53,33 56,23 47,28", fill: "oklch(0.85 0.16 350)" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "ellipse",
                  {
                    cx: "29",
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("circle", { cx: 30 + headTilt * 0.04, cy: "41.5", r: "0.8", fill: "white" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("circle", { cx: 44 + headTilt * 0.04, cy: "41.5", r: "0.8", fill: "white" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "ellipse",
                  {
                    cx: "36",
...
const BirthdayContext = reactExports.createContext(false);
const PhotoModalContext = reactExports.createContext(
  () => {
  }
);
function useOpenPhoto() {
  return reactExports.useContext(PhotoModalContext);
}
function ParticleCanvas() {
  ...
  reactExports.useEffect(() => {
    ...
    const spawn = () => ({
      ...
      opacity: 0,
      type: ["star", "circle", "dot"][Math.floor(Math.random() * 3)],
    ...
    const tick = () => {
      ...
      for (let i = particles.length - 1; i >= 0; i--) {
        ...
        p.opacity = life < 0.1 ? life * 10 : life > 0.85 ? (1 - life) / 0.15 : 1;
        if (p.age >= p.maxAge) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("canvas", { ref: canvasRef, id: "particle-canvas", tabIndex: -1 });
}
...
function useTimelineSpine() {
  const spineRef = reactExports.useRef(null);
  reactExports.useEffect(() => {
...
function BirthdayFireworks({ onClose }) {
  const canvasRef = reactExports.useRef(null);
  reactExports.useEffect(() => {
    const canvas = canvasRef.current;
    if (!canvas) return;
      ...
      "div",
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { fontSize: "3rem", marginBottom: "0.5rem" }, children: "🎆🎇✨🎉🎊" }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "h1",
                {
                  style: {
                    ...
                    fontWeight: 900,
                    background: "linear-gradient(135deg, #ff6fc8, #ffd93d, #6bcb77, #4d96ff)",
                    WebkitBackgroundClip: "text",
                    WebkitTextFillColor: "transparent",
                    backgroundClip: "text",
                    lineHeight: 1.2,
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { fontSize: "2.5rem", marginBottom: "1.5rem" }, children: "❤️ ❤️ ❤️" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "p",
                {
                  style: {
                  ...
                  children: "Wishing you the most magical day, babe! 🥳"
                }
              ),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "button",
                {
                  ...
                  style: {
                    background: "linear-gradient(135deg, oklch(0.55 0.25 320), oklch(0.55 0.2 280))",
                    border: "none",
                    borderRadius: "999px",
...
function GameHUD() {
  ...
  const [achievement, setAchievement] = reactExports.useState(null);
  const [hiding, setHiding] = reactExports.useState(false);
  const unlockedRef = reactExports.useRef(/* @__PURE__ */ new Set());
  const timerRef = reactExports.useRef(null);
  const BIRTHDAY = new Date(2026, 3, 6, 0, 0, 0);
  const isBirthday = () => {
    const now2 = /* @__PURE__ */ new Date();
    return now2.getMonth() === 3 && now2.getDate() === 6;
  };
  const [timeLeft, setTimeLeft] = reactExports.useState(() => {
    const now2 = /* @__PURE__ */ new Date();
    return Math.max(0, BIRTHDAY.getTime() - now2.getTime());
  });
  const [showBirthday, setShowBirthday] = reactExports.useState(() => isBirthday());
  const birthdayTriggeredRef = reactExports.useRef(false);
  reactExports.useEffect(() => {
    const nowCheck = /* @__PURE__ */ new Date();
    if (nowCheck.getMonth() === 3 && nowCheck.getDate() === 6 && !birthdayTriggeredRef.current) {
      birthdayTriggeredRef.current = true;
      setShowBirthday(true);
    }
    const iv = setInterval(() => {
      const now2 = /* @__PURE__ */ new Date();
      const diff = BIRTHDAY.getTime() - now2.getTime();
      if (diff <= 0) {
        setTimeLeft(0);
  ...
  const showAchievement = reactExports.useCallback((ach) => {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "span",
            {
              ...
              children: "🎂 Birthday Countdown"
            }
          ),
          timeLeft > 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex gap-2 items-end", children: [
            { v: days, l: "D" },
            { v: hours, l: "H" },
            { v: minutes, l: "M" },
            { v: seconds, l: "S" }
          ...
          ] }, l)) }) : /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { fontSize: "1.2rem" }, children: "🎉 Today!" })
        ]
      }
    ),
    showBirthday && /* @__PURE__ */ jsxRuntimeExports.jsx(BirthdayFireworks, { onClose: () => setShowBirthday(false) }),
    achievement && /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        "data-ocid": "hud.toast",
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { fontSize: "1.5rem" }, children: achievement.emoji }),
  ...
  if (src) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
        ...
        style: {
          ...style2,
          border: glowColor ? `2px solid ${glowColor}` : void 0,
          padding: 0,
          overflow: "hidden",
          cursor: "pointer"
        },
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "header",
    {
      ...
      style: {
        ...
        borderBottom: scrolled ? "1px solid oklch(0.40 0.10 280 / 0.35)" : "none",
        marginTop: "4px"
      },
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-6 py-3 flex items-center justify-between", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "a",
            {
              href: "#home",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("nav", { className: "hidden lg:flex items-center gap-6", children: navLinks.map((link) => /* @__PURE__ */ jsxRuntimeExports.jsx(
            "a",
            {
              href: link.href,
              className: "nav-link",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
              ...
              children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-6 flex flex-col gap-1.5", children: ["top", "mid", "bot"].map((lineId) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                "span",
                {
                  className: "h-0.5 w-full block transition-all",
                  style: {
                    background: "var(--neon-cyan)",
                    transform: mobileOpen && lineId === "top" ? "rotate(45deg) translate(3px, 5px)" : mobileOpen && lineId === "bot" ? "rotate(-45deg) translate(3px, -5px)" : void 0,
...
function Hero() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "section",
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-6xl mx-auto w-full", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid md:grid-cols-2 gap-12 items-center", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-6", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "h1",
              {
                ...
                children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("br", {}),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "gold-text", children: "Meghna!" })
                ]
              }
            )
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "p",
            {
              ...
              children: "Every moment with you is a gift. Today, we celebrate you your radiance, your brilliance, and the beautiful love we share."
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            ...
            "div",
            {
              ...
              children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                "span",
                {
                  ...
                  children: "✦ With all my love, always & forever"
                }
              )
            }
          )
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative", style: { width: "min(340px, 80vw)" }, children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(HeroImage, {}),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "div",
                  {
...
function TimelineSection() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "story", className: "section section-story", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-5xl mx-auto", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-20 reveal relative", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        SectionBadge,
        {
          chapter: "Chapter 2",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "h2",
        {
          ...
          children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "rainbow-text", children: "How We Met ✨" })
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "div",
        {
          ...
          style: {
            width: 80,
            height: 3,
            background: "linear-gradient(90deg, transparent, oklch(0.75 0.20 350), transparent)",
            borderRadius: 4
          }
        }
      ),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-col gap-16", children: timelineEntries.map((entry, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
        "div",
        {
          className: entry.side === "left" ? "reveal-left" : "reveal-right",
          style: { transitionDelay: `${i * 0.12}s` },
          children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-6 md:gap-0", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "div",
              {
                className: `hidden md:flex md:w-5/12 ${entry.side === "left" ? "justify-end pr-10" : "justify-start pl-10 order-last"}`,
                children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "div",
                  {
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "hidden md:flex w-2/12 justify-center relative z-10", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
              "div",
              {
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "w-full md:w-5/12", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "glass-card p-5 md:hidden", children: [
...
function ForYouSection() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "for-you", className: "section section-foryou", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-5xl mx-auto", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-16 reveal relative", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        SectionBadge,
        {
          chapter: "Chapter 3",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "h2",
        {
          className: "font-display mt-5",
          style: { fontSize: "clamp(2rem, 5vw, 3.5rem)" },
          children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "shimmer-text", children: "Everything About You 💫" })
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "div",
        {
          ...
          style: {
            width: 80,
            height: 3,
            background: "linear-gradient(90deg, transparent, oklch(0.82 0.18 135), transparent)",
            borderRadius: 4
          }
        }
      ),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid md:grid-cols-2 gap-8 stagger-grid", children: [
      {
        color: "oklch(0.75 0.20 350)",
        tag: "✦ Her Beauty",
        title: "Your Radiance & Grace",
        photo: "Meghna's Photo",
        photoSrc: "/assets/uploads/WhatsApp-Image-2026-03-20-at-3.19.26-PM-5.jpeg",
    ...
    ].map((card, cardIdx) => /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { padding: "1.75rem" }, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            PhotoSlot,
            {
              label: card.photo,
...
function GallerySection() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "gallery", className: "section section-gallery", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-6xl mx-auto", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-16 reveal relative", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        SectionBadge,
        {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "h2",
        {
          className: "font-display mt-5",
          style: { fontSize: "clamp(2rem, 5vw, 3.5rem)" },
          children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "shimmer-text", children: "📸 A Gallery of Beauty" })
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "p",
        {
          ...
          children: "Every photo of Meghna is a masterpiece. Every moment, irreplaceable."
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "div",
        {
          ...
          style: {
            width: 80,
            height: 3,
            background: "linear-gradient(90deg, transparent, oklch(0.82 0.18 196), transparent)",
            borderRadius: 4
          }
        }
      ),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 md:grid-cols-3 gap-4 mb-4", children: gallerySlots.slice(0, 3).map((slot, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
              ...
              children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                "img",
                {
                  ...
                  style: {
                    ...
                    objectFit: "contain",
                    display: "block",
                    transform: slot.rotate ? `rotate(${slot.rotate}deg)` : void 0,
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 md:grid-cols-4 gap-4 mb-4", children: gallerySlots.slice(3, 7).map((slot, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        className: "gallery-slot reveal relative",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 md:grid-cols-4 gap-4", children: gallerySlots.slice(7, 10).map((slot, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        className: "gallery-slot reveal relative",
...
function LoveLetter() {
  const isBirthday = reactExports.useContext(BirthdayContext);
  const [envelopeOpen, setEnvelopeOpen] = reactExports.useState(false);
  const [showFireworks, setShowFireworks] = reactExports.useState(false);
  const setSelectedPhoto = reactExports.useContext(PhotoModalContext);
  reactExports.useEffect(() => {
    if (isBirthday) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "section",
    {
      ...
      children: [
        showFireworks && fireworkParticles.map((p) => /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-5xl mx-auto", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-12 reveal relative", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              SectionBadge,
              {
                chapter: "Chapter 6",
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "h2",
              {
                ...
                children: "A Love Letter to You"
              }
            )
          ] }),
          !isBirthday ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "envelope-wrapper reveal", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "envelope-body", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "envelope-flap" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "envelope-seal", children: "💌" }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "envelope-lines", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "envelope-line" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "envelope-line" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "envelope-line" })
              ] })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "p",
              {
                ...
                children: "A special letter sealed just for Meghna"
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "p",
            ...
            "div",
            {
              ...
              children: envelopeOpen && /* @__PURE__ */ jsxRuntimeExports.jsx(
                "div",
                {
                  ...
                  children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid md:grid-cols-5 gap-0", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsxs(
                      "div",
                      {
                        ...
                        children: [
                          ...
                          /* @__PURE__ */ jsxRuntimeExports.jsxs(
                            "div",
                            {
                              ...
                              children: [
                                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "Already been like 7 years eh since I know you, and they say if your friendship lasts longer than 7 years then it is gonna last for your life. I hope and am sure that's true because you are much more than just my best friend, you're the love of my life." }),
                                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "We have been through so many highs and that many lows that I've lost count. But the good news is, it means no matter what may come, we jump over it together and forever." }),
                                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "May your day and everyday be happier than the last. May you achieve all the good things in life. May we achieve them together." }),
                                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "I love you hon. Have a good 26th <3" })
                              ]
                            }
                          ),
                          /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "md:col-span-2 p-8 flex flex-col items-center gap-6", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "button",
                        {
                          type: "button",
                          ...
                          onClick: () => setSelectedPhoto == null ? void 0 : setSelectedPhoto({
...
function Footer() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "footer",
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-5xl mx-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid md:grid-cols-3 gap-8 items-center", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs", style: { color: "oklch(0.50 0.06 280)" }, children: "A love story written in stars." })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap gap-3 items-center md:justify-center", children: footerLinks.map((link) => /* @__PURE__ */ jsxRuntimeExports.jsx(
          "a",
          {
            href: link.href,
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-col items-start md:items-end gap-1", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs", style: { color: "oklch(0.45 0.05 280)" }, children: [
          "© ",
          year,
          ". Built with",
          " ",
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color: "var(--neon-pink)" }, children: "♥" }),
          " using",
          " ",
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "a",
...
function App() {
  ...
  const [showBirthday] = reactExports.useState(() => checkBirthday());
  reactExports.useEffect(() => {
    const onKey = (e) => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(BirthdayContext.Provider, { value: showBirthday, children: /* @__PURE__ */ jsxRuntimeExports.jsx(PhotoModalContext.Provider, { value: setSelectedPhoto, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(GameHUD, {}),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Navbar, {}),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("main", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Hero, {}),
          /* @__PURE__ */ jsxRuntimeExports.jsx(TimelineSection, {}),
          /* @__PURE__ */ jsxRuntimeExports.jsx(ForYouSection, {}),
          /* @__PURE__ */ jsxRuntimeExports.jsx(GallerySection, {}),
          /* @__PURE__ */ jsxRuntimeExports.jsx(LoveLetter, {})
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Footer, {}),
        /* @__PURE__ */ jsxRuntimeExports.jsx(WalkingCatsLayer, {}),
        selectedPhoto && /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
...
Service({
  "getBirthdayMessage": Func([], [Text], ["query"]),
  "getTitle": Func([], [Text], ["query"]),
  "getViews": Func([], [Nat], ["query"]),
  "recordVisit": Func([], [Nat], []),
  "resetBirthdayMessage": Func([], [], []),
  "resetTitle": Func([], [], []),
  "setBirthdayMessage": Func([Text], [], []),
  "setTitle": Func([Text], [], [])
});
